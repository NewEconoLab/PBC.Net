...
*/
static void pairing_pp_init(pairing_pp_t p, element_t in1, pairing_t pairing) {
  if (element_is0(in1)) {
    p->pairing = NULL;
    return;
  }
...
*/
static void pairing_pp_clear(pairing_pp_t p) {
  if (!p->pairing) {
...
*/
static void pairing_pp_apply(element_t out, element_t in2, pairing_pp_t p) {
  if (!p->pairing) {
    element_set0(out);
    return;
  }
...
static void pairing_apply(element_t out, element_t in1, element_t in2,
    pairing_t pairing) {
...
*/
static void element_pairing(element_t out, element_t in1, element_t in2) {
...
*/
static void element_prod_pairing(
